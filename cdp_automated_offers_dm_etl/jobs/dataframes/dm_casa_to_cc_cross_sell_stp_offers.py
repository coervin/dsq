...
from cdp_automated_offers_dm_etl.operations.transformers.transform_dm_casa_to_cc_cross_sell_stp_offers import (
    transform_dm_casa_to_cc_cross_sell_stp_offers,
)


class AutoOffersDmCasaToCCSTPOffers(ComposableJob):
