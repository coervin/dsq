...
transform_dm_casa_to_hl_cross_sell_stp_offers = (
    Table.transformer()
    .with_filename("transform_dm_casa_to_hl_cross_sell_stp_offers")
    ...
    .with_params(
        dynamic_json_rules=get_dynamic_sql_condition(rules_file="dm_casa_to_hl_cross_sell_stp_offers.json") 
    )
)