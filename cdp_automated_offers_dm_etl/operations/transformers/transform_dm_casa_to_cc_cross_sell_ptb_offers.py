...
transform_dm_casa_to_cc_cross_sell_ptb_offers = (
    Table.transformer()
    .with_filename("transform_dm_casa_to_cc_cross_sell_ptb_offers")
    ...
    .add_kwargs(
        dynamic_json_rules=get_dynamic_sql_condition(rules_file="dm_casa_to_cc_cross_sell_ptb_offers.json") 
    )
)